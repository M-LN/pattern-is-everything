...
const PATTERN_BRIDGES = {
  'confirmation-bias': '<div class="callout bridge"><strong>Pattern bridge:</strong> Seeing what you expect to see is <a href="../../ml-math/#bias-variance" target="_blank" rel="noopener">high bias</a> in ML — the model only fits its prior assumption.</div>',
  ...
  'regret-aversion': '<div class="callout bridge"><strong>Pattern bridge:</strong> Avoiding regret over avoiding loss is a second-order bias. In ML, <a href="../../ml-math/#regularization" target="_blank" rel="noopener">regularization</a> trades some training error for less regret on unseen data.</div>',
  ...
  'disposition-effect': '<div class="callout bridge"><strong>Pattern bridge:</strong> Selling winners too early, holding losers too long. In ML, <a href="../../ml-math/#lr-schedule" target="_blank" rel="noopener">learning rate scheduling</a> fights the same instinct: slow down on gains, keep going through losses.</div>',
  ...
  'fomo': '<div class="callout bridge"><strong>Pattern bridge:</strong> Fear of missing out drives late entries at peaks. In ML, <a href="../../ml-math/#optimizers" target="_blank" rel="noopener">momentum overshoot</a> is the same — too much velocity past the optimum.</div>',
  ...
  'contrarian-thinking': '<div class="callout bridge"><strong>Pattern bridge:</strong> Going against the crowd is the <a href="../../ml-math/#gan" target="_blank" rel="noopener">discriminator in a GAN</a> — an adversary that bets against the prevailing signal.</div>',
  'information-cascades': '<div class="callout bridge"><strong>Pattern bridge:</strong> Sequential decisions amplifying a signal regardless of private information. In ML, this mirrors <a href="../../ml-math/#backprop" target="_blank" rel="noopener">gradient cascading</a> in deep networks.</div>',
  'sunk-cost-fallacy': '<div class="callout bridge"><strong>Pattern bridge:</strong> Weighting past investment that can’t be recovered. In ML, <a href="../../ml-math/#regularization" target="_blank" rel="noopener">early stopping</a> fights sunk-cost thinking: stop training even though you’ve invested epochs.</div>',
  ...
  'framing-effect': '<div class="callout bridge"><strong>Pattern bridge:</strong> How information is presented changes the decision — the same data, different conclusions. In statistics, <a href="../../stats/#mean-median" target="_blank" rel="noopener">mean vs. median</a> can frame the same dataset differently.</div>',
  ...
  'status-quo-bias': '<div class="callout bridge"><strong>Pattern bridge:</strong> Preferring the current state over change. In ML, <a href="../../ml-math/#regularization" target="_blank" rel="noopener">L2 regularization</a> pulls weights toward zero — a mathematical preference for the status quo.</div>',
  'market-sentiment-cycle': '<div class="callout bridge"><strong>Pattern bridge:</strong> The emotional arc from optimism to euphoria to panic to hope is a <a href="../../stats/#normal" target="_blank" rel="noopener">distribution cycle</a>. In ML, <a href="../../ml-math/#lr-schedule" target="_blank" rel="noopener">cyclic learning rates</a> deliberately walk through this arc.</div>',
  'accumulation-distribution': '<div class="callout bridge"><strong>Pattern bridge:</strong> Smart money quietly building positions before the crowd notices. In ML, <a href="../../ml-math/#optimizers" target="_blank" rel="noopener">gradient accumulation</a> before an optimizer step is the same: gather signals silently, then act.</div>',
  'euphoria-panic': '<div class="callout bridge"><strong>Pattern bridge:</strong> Extreme sentiment at both ends of the <a href="../../stats/#normal" target="_blank" rel="noopener">distribution tails</a>. In ML, <a href="../../ml-math/#diffusion" target="_blank" rel="noopener">diffusion models</a> add noise (panic) then learn to reverse it (recovery).</div>',
