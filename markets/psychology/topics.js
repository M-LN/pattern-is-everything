...
const PATTERN_BRIDGES = {
  'confirmation-bias': '<div class="callout bridge"><strong>Pattern bridge:</strong> Seeing what you expect to see is <a href="../../ml-math/#bias-variance" target="_blank" rel="noopener">high bias</a> in ML — the model only fits its prior assumption. In poetry, <a href="../../poetry/rhetoric/#allegory" target="_blank" rel="noopener">allegory</a> confirms a predetermined moral, filtering the story to match.</div>',
  'anchoring': '<div class="callout bridge"><strong>Pattern bridge:</strong> Anchoring to a reference price is the psychological cousin of <a href="../../stats/#mean-median" target="_blank" rel="noopener">the mean</a> — a central value everything is measured from. In ML, <a href="../../ml-math/#weight-init" target="_blank" rel="noopener">weight initialization</a> anchors where training begins.</div>',
  'recency-bias': '<div class="callout bridge"><strong>Pattern bridge:</strong> Overweighting recent events is the human version of <a href="../../markets/indicators/#ema" target="_blank" rel="noopener">exponential moving averages</a>. In ML, <a href="../../ml-math/#crossval" target="_blank" rel="noopener">cross-validation</a> exists specifically to prevent this — don’t just test on the latest fold.</div>',
  'availability-heuristic': '<div class="callout bridge"><strong>Pattern bridge:</strong> Judging probability by what comes to mind is <a href="../../stats/#probability-distributions" target="_blank" rel="noopener">probability estimation</a> gone wrong — confusing salience with frequency. In ML, <a href="../../ml-math/#metrics" target="_blank" rel="noopener">accuracy vs. recall</a> captures the same distortion.</div>',
  'hindsight-bias': '<div class="callout bridge"><strong>Pattern bridge:</strong> Believing you knew it all along is <a href="../../ml-math/#bias-variance" target="_blank" rel="noopener">overfitting to the training set</a> — perfect past fit, no future predictive power. In statistics, <a href="../../stats/#hypothesis-testing" target="_blank" rel="noopener">p-hacking</a> manufactures the same false certainty.</div>',
  'fear-and-greed': '<div class="callout bridge"><strong>Pattern bridge:</strong> The cycle between fear and greed drives volatility — the emotional driver behind <a href="../../stats/#variance-std" target="_blank" rel="noopener">variance</a>. In ML, <a href="../../ml-math/#softmax" target="_blank" rel="noopener">softmax temperature</a> mimics this: cold = greedy certainty, hot = fearful uniformity.</div>',
  'loss-aversion': '<div class="callout bridge"><strong>Pattern bridge:</strong> Losses hurt twice as much as equivalent gains — an asymmetric <a href="../../ml-math/#loss" target="_blank" rel="noopener">loss function</a>. In statistics, it’s why <a href="../../stats/#skewness" target="_blank" rel="noopener">skewness</a> matters: symmetric distributions don’t capture human perception.</div>',
  'regret-aversion': '<div class="callout bridge"><strong>Pattern bridge:</strong> Avoiding regret over avoiding loss is a second-order bias. In ML, <a href="../../ml-math/#regularization" target="_blank" rel="noopener">regularization</a> trades some training error for less regret on unseen data. In poetry, the <a href="../../poetry/forms/#elegy" target="_blank" rel="noopener">elegy</a> is the genre of regret.</div>',
  'overconfidence': '<div class="callout bridge"><strong>Pattern bridge:</strong> Too-narrow confidence intervals from too much certainty. In statistics, this is literally <a href="../../stats/#confidence-intervals" target="_blank" rel="noopener">miscalibrated confidence intervals</a>. In ML, <a href="../../ml-math/#bias-variance" target="_blank" rel="noopener">low bias, high variance</a> — the overfit model that’s sure it’s right.</div>',
  'disposition-effect': '<div class="callout bridge"><strong>Pattern bridge:</strong> Selling winners too early, holding losers too long. In ML, <a href="../../ml-math/#lr-schedule" target="_blank" rel="noopener">learning rate scheduling</a> fights the same instinct: slow down on gains, keep going through losses. In poetry, <a href="../../poetry/sound/#enjambment" target="_blank" rel="noopener">enjambment</a> resists the urge to stop at the comfortable line break.</div>',
  'herd-behavior': '<div class="callout bridge"><strong>Pattern bridge:</strong> Following the crowd is a <a href="../../ml-math/#rlhf" target="_blank" rel="noopener">collective reward signal</a> — the market’s version of RLHF. In statistics, it produces <a href="../../stats/#correlation" target="_blank" rel="noopener">spurious correlation</a> as everyone moves together.</div>',
  'fomo': '<div class="callout bridge"><strong>Pattern bridge:</strong> Fear of missing out drives late entries at peaks. In ML, <a href="../../ml-math/#optimizers" target="_blank" rel="noopener">momentum overshoot</a> is the same — too much velocity past the optimum. In poetry, <a href="../../poetry/rhetoric/#hyperbole" target="_blank" rel="noopener">hyperbole</a> is verbal FOMO: overstating to not miss the mark.</div>',
  'social-proof': '<div class="callout bridge"><strong>Pattern bridge:</strong> Copying others as a decision shortcut is an <a href="../../ml-math/#embeddings" target="_blank" rel="noopener">embedding heuristic</a> — if nearby vectors do it, so should I. In statistics, it’s the <a href="../../stats/#central-limit" target="_blank" rel="noopener">law of large numbers</a> misapplied: consensus ≠ correctness.</div>',
  'contrarian-thinking': '<div class="callout bridge"><strong>Pattern bridge:</strong> Going against the crowd is the <a href="../../ml-math/#gan" target="_blank" rel="noopener">discriminator in a GAN</a> — an adversary that bets against the prevailing signal. In poetry, <a href="../../poetry/rhetoric/#irony" target="_blank" rel="noopener">irony</a> says the opposite of what it means.</div>',
  'information-cascades': '<div class="callout bridge"><strong>Pattern bridge:</strong> Sequential decisions amplifying a signal regardless of private information. In ML, this mirrors <a href="../../ml-math/#backprop" target="_blank" rel="noopener">gradient cascading</a> in deep networks. In poetry, <a href="../../poetry/sound/#anaphora" target="_blank" rel="noopener">anaphora</a> cascades the same opening phrase forward, amplifying emphasis.</div>',
  'sunk-cost-fallacy': '<div class="callout bridge"><strong>Pattern bridge:</strong> Weighting past investment that can’t be recovered. In ML, <a href="../../ml-math/#regularization" target="_blank" rel="noopener">early stopping</a> fights sunk-cost thinking: stop training even though you’ve invested epochs. In poetry, knowing when to <a href="../../poetry/sound/#end-stopped" target="_blank" rel="noopener">end-stop a line</a> instead of dragging it on.</div>',
  'gambler-fallacy': '<div class="callout bridge"><strong>Pattern bridge:</strong> Expecting past outcomes to influence independent future ones. In statistics, this is misunderstanding <a href="../../stats/#probability-distributions" target="_blank" rel="noopener">independent probability</a>. In ML, each <a href="../../ml-math/#crossval" target="_blank" rel="noopener">cross-validation fold</a> is an independent trial.</div>',
  'framing-effect': '<div class="callout bridge"><strong>Pattern bridge:</strong> How information is presented changes the decision — the same data, different conclusions. In statistics, <a href="../../stats/#mean-median" target="_blank" rel="noopener">mean vs. median</a> can frame the same dataset differently. In poetry, <a href="../../poetry/rhetoric/#litotes" target="_blank" rel="noopener">litotes</a> reframes a positive as a double negative.</div>',
  'mental-accounting': '<div class="callout bridge"><strong>Pattern bridge:</strong> Treating money differently based on its source or bucket. In ML, <a href="../../ml-math/#batchnorm" target="_blank" rel="noopener">batch normalization</a> per-group treats each layer’s activations as separate accounts. In statistics, <a href="../../stats/#simpsons-paradox" target="_blank" rel="noopener">Simpson’s paradox</a> shows how grouping changes conclusions.</div>',
  'status-quo-bias': '<div class="callout bridge"><strong>Pattern bridge:</strong> Preferring the current state over change. In ML, <a href="../../ml-math/#regularization" target="_blank" rel="noopener">L2 regularization</a> pulls weights toward zero — a mathematical preference for the status quo. In poetry, <a href="../../poetry/forms/#shakespearean-sonnet" target="_blank" rel="noopener">traditional forms</a> embody the pull toward convention.</div>',
  'market-sentiment-cycle': '<div class="callout bridge"><strong>Pattern bridge:</strong> The emotional arc from optimism to euphoria to panic to hope is a <a href="../../stats/#normal" target="_blank" rel="noopener">distribution cycle</a>. In ML, <a href="../../ml-math/#lr-schedule" target="_blank" rel="noopener">cyclic learning rates</a> deliberately walk through this arc. In poetry, the <a href="../../poetry/forms/#petrarchan-sonnet" target="_blank" rel="noopener">Petrarchan volta</a> is the sentiment turning point.</div>',
  'accumulation-distribution': '<div class="callout bridge"><strong>Pattern bridge:</strong> Smart money quietly building positions before the crowd notices. In ML, <a href="../../ml-math/#optimizers" target="_blank" rel="noopener">gradient accumulation</a> before an optimizer step is the same: gather signals silently, then act. In poetry, a <a href="../../poetry/rhetoric/#climax" target="_blank" rel="noopener">climax</a> accumulates intensity before the peak.</div>',
  'euphoria-panic': '<div class="callout bridge"><strong>Pattern bridge:</strong> Extreme sentiment at both ends of the <a href="../../stats/#normal" target="_blank" rel="noopener">distribution tails</a>. In ML, <a href="../../ml-math/#diffusion" target="_blank" rel="noopener">diffusion models</a> add noise (panic) then learn to reverse it (recovery). In poetry, <a href="../../poetry/rhetoric/#hyperbole" target="_blank" rel="noopener">hyperbole</a> captures euphoria while <a href="../../poetry/rhetoric/#understatement" target="_blank" rel="noopener">understatement</a> captures the numb aftermath.</div>',
  'smart-money-dumb-money': '<div class="callout bridge"><strong>Pattern bridge:</strong> The information asymmetry between sophisticated and retail traders. In ML, <a href="../../ml-math/#kl-div" target="_blank" rel="noopener">KL divergence</a> measures the gap between what one model knows and another doesn’t. In statistics, it’s the difference between the <a href="../../stats/#bayes" target="_blank" rel="noopener">prior and the posterior</a>.</div>',
  'mean-reversion-psychology': '<div class="callout bridge"><strong>Pattern bridge:</strong> The belief that extremes return to average — a psychological trust in the <a href="../../stats/#central-limit" target="_blank" rel="noopener">central limit theorem</a>. In ML, <a href="../../ml-math/#batchnorm" target="_blank" rel="noopener">normalization layers</a> enforce mean reversion on activations. In poetry, a <a href="../../poetry/sound/#cadence" target="_blank" rel="noopener">cadence</a> returns to its base rhythm.</div>'
};
