...
const PATTERN_BRIDGES = {
  ...
  'ema': '<div class="callout bridge"><strong>Pattern bridge:</strong> Exponential weighting of recent data is exactly how <a href="../../ml-math/#optimizers" target="_blank" rel="noopener">Adam’s momentum</a> tracks gradient history.</div>',
  ...
  'williams-r': '<div class="callout bridge"><strong>Pattern bridge:</strong> Williams %R is the stochastic oscillator inverted — same math, different perspective. Like <a href="../../stats/#percentiles" target="_blank" rel="noopener">percentiles</a> read from top instead of bottom.</div>',
  ...
  'macd': '<div class="callout bridge"><strong>Pattern bridge:</strong> The difference between two EMAs is a <a href="../../ml-math/#loss" target="_blank" rel="noopener">residual</a> — what the fast signal sees that the slow one doesn’t.</div>',
  ...
  'parabolic-sar': '<div class="callout bridge"><strong>Pattern bridge:</strong> SAR’s acceleration factor increases with each new extreme — the same <a href="../../ml-math/#optimizers" target="_blank" rel="noopener">momentum accumulation</a> used in gradient descent.</div>',
  ...
  'aroon': '<div class="callout bridge"><strong>Pattern bridge:</strong> Time since highest high vs. lowest low measures where you are in a cycle. The same temporal awareness drives <a href="../../ml-math/#rnn" target="_blank" rel="noopener">RNN hidden states</a>.</div>',
  ...
  'keltner-channels': '<div class="callout bridge"><strong>Pattern bridge:</strong> EMA ± ATR multiples blend trend and volatility — like <a href="../../stats/#confidence-intervals" target="_blank" rel="noopener">confidence intervals</a> around a moving center.</div>',
  'donchian-channels': '<div class="callout bridge"><strong>Pattern bridge:</strong> Highest high and lowest low over N periods is the <a href="../../stats/#percentiles" target="_blank" rel="noopener">range (max-min)</a> from descriptive statistics.</div>',
  ...
  'accumulation-distribution': '<div class="callout bridge"><strong>Pattern bridge:</strong> A/D line weights volume by where price closes in its range — an <a href="../../ml-math/#attention" target="_blank" rel="noopener">attention-weighted</a> running total.</div>',
