...
2. Open the `.ipynb` notebook in VS Code or local Jupyter for fuller local workflows.
3. Run the install cell if your environment is missing dependencies.
4. Start with the housing regression section, which uses the local `cases/datasets/housing_sample.csv` file.
